...
if __name__ == '__main__':
    ...
    p = player("mic.wav")
    l = listener(r, p)
    print('Maintenez la barre d espace pour enregistrer, appuyez sur p pour réécouter, appuyez sur t pour transcrire, appuyez sur q pour quitter')
